...
import static com.notquitehere.selfdriver.domain.SensorType.EMERGENCY_TURBO;
...
public class WhenSelfDriverReceivesTurboEvents extends SelfDriverTestBase {
    ...
    public void speedIncreases() {
        SensorEvent[] events = {
            speedLimit(50),
            simpleEvent(EMERGENCY_TURBO)
        };

        verifyEventResponses(NORMAL, events, expectSpeeds(50, 70));
        verifyEventResponses(SPORT, events, expectSpeeds(55, 85));
        verifyEventResponses(SAFE, events, expectSpeeds(45, 55));
    }
    ...
    public void turboCanOnlyBeAppliedOnce() {
        ...
        verifyEventResponses(NORMAL, events, expectSpeeds(50, 70, 50, 50));
        verifyEventResponses(SPORT, events, expectSpeeds(55, 85, 55, 55));
        verifyEventResponses(SAFE, events, expectSpeeds(45, 55, 45, 45));
    }
